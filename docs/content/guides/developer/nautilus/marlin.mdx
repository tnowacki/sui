...
It transforms TEE access into a transparent and decentralized marketplace. A Move contract enables developers to submit jobs, pay with stablecoins, and expose workloads to Oyster operators. Builds are deterministic, meaning enclave integrity and identity are fully verifiable.
...
1. The enclave generates a PCR measurement that acts as a cryptographic verification of the application's code. A Move contract can verify this PCR measurement on-chain.
