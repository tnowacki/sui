...
In Move packages, you must either transfer every value that does not have the `drop` ability to another address, explicitly destroy it, or use it as input for another function to consume. 
...
- [Signing and Sending Transactions](/guides/developer/transactions/ptbs/sign-and-send-txn)
